...
if (isBrowser()) {
  class AddToCalendarButton extends HTMLElement {
    ...
    disconnectedCallback() {
      ...
      if (document.querySelectorAll('add-button-to-calendar').length == 0) {
        atcbBtnCount = 0;
      }
    }
  ...
  if (!customElements.get('add-button-to-calendar')) {
    customElements.define('add-button-to-calendar', AddToCalendarButton);
  }
}
